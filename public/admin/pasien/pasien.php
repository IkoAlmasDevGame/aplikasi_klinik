                     ...
                     <div class="card-body my-2">
                        <div class="card-tools">
                           <div class="text-start">
                              <?php if ($_SESSION['hak_akses'] == "admin"): ?>
                              <a href="?aksi=tambah-pasien" aria-current="page" class="btn btn-danger btn-xs">
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       <td class="text-center fw-normal">
                                          <a href="?aksi=pasien_hapus&id_pasien=<?= $bc['id_pasien'] ?>"
                                             onclick="return confirm('Apakah anda ingin menghapus data pasien ini ?')"
                                             aria-current="page" class="btn btn-sm btn-danger">
                                             <i class="fas fa-trash-alt fa-1x fa-fw"></i>
                                          </a>
                                          <a href="?aksi=edit-pasien&id_pasien=<?= $bc['id_pasien'] ?>"
