               ...
               <div class="panel panel-body bg-body-tertiary p-5">
                  <div class="panel panel-heading">
                     ...
                     <div class="d-flex justify-content-end align-items-end flex-wrap">
                        ...
                        <li class="breadcrumb breadcrumb-item">
                           <a href="?page=laporan-dokter" aria-current="page" class="text-decoration-none">
                              <?php echo $data[1]; ?>
                           </a>
                        </li>
                     </div>
                     ...
                     <div class="card-body my-2">
                        <div class="card-tools">
                           <div class="text-start my-1">
                              <a href="?page=print_dokter" aria-current="page" class="btn btn-danger">
                                 <i class="fas fa-print fa-fw fa-1x"></i>
                                 Print File
                              </a>
                              <a href="?page=pdf_dokter" aria-current="page" class="btn btn-info btn-outline-dark">
