               ...
               <div class="panel panel-body bg-body-tertiary p-5">
                  <div class="panel panel-heading">
                     ...
                     <div class="d-flex justify-content-end align-items-end flex-wrap">
                        ...
                        <li class="breadcrumb breadcrumb-item">
                           <a href="?aksi=tambah-dokter" aria-current="page" class="text-decoration-none">
                              <?php echo $data[1]; ?>
                           </a>
                        </li>
                     </div>
                        ...
                        <div class="col-sm-6 col-md-6">
                           <div class="card shadow mb-1">
                              ...
                              <div class="card-body my-1">
                                 <form action="?aksi=dokter_tambah" class="form-group" method="post">
                                    <div class="form-inline my-1">
                                       <div class="row justify-content-center align-items-center flex-wrap">
                                          ...
                                          <div class="col-sm-6">
                                             <?php echo $input->form_input("text", "", "30", "form-control", "pengguna", "Enter Text ...", "", ""); ?>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="form-inline my-1">
                                    ...
                                    <div class="form-inline my-1">
                                       <div class="row justify-content-center align-items-center flex-wrap">
                                          ...
                                          <div class="col-sm-6">
                                             <?php echo $input->form_input("text", "", "30", "form-control", "nama_dokter", "masukkan nama dokter disini ...", "", ""); ?>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="form-inline my-1">
