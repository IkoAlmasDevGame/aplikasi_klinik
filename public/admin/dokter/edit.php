               ...
               <div class="panel panel-body bg-body-tertiary p-5">
                  <div class="panel panel-heading">
                     ...
                     <div class="d-flex justify-content-end align-items-end flex-wrap">
                        ...
                        <li class="breadcrumb breadcrumb-item">
                           <a href="?aksi=edit-dokter&id_dokter=<?= $_GET['id_dokter'] ?>" aria-current="page"
                        ...
                        <div class="col-sm-6 col-md-6">
                           <div class="card shadow mb-1">
                              ...
                              <div class="card-body my-1">
                                 <?php $result = $input->query("SELECT * FROM tb_dokter JOIN tb_user ON tb_dokter.id_dokter = tb_user.id_dokter WHERE tb_dokter.id_dokter = '$_GET[id_dokter]'"); ?>
                                 <?php $data = mysqli_fetch_array($result); ?>
                                 <form action="?aksi=dokter_edit" class="form-group" method="post">
                                    <div class="form-inline my-1">
                                       <div class="row justify-content-center align-items-center flex-wrap">
                                          ...
                                          <div class="col-sm-6">
                                             <?php echo $input->form_input("text", "", "30", "form-control", "pengguna", "Enter Text ...", "", $data['pengguna']); ?>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="form-inline my-1">
                                       <div class="row justify-content-center align-items-center flex-wrap">
                                          ...
                                          <div class="col-sm-6">
                                             <?php echo $input->form_input("password", "", "30", "form-control", "sandi", "Enter Text ...", "", ""); ?>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="my-1 border border-top"></div>
                                    <div class="form-inline my-1">
                                       <div class="row justify-content-center align-items-center flex-wrap">
                                          <div class="form-label col-sm-4">
                                          ...
                                          <div class="col-sm-6">
                                             <?php echo $input->form_input("text", "", "30", "form-control", "nama_dokter", "masukkan nama dokter disini ...", "", $data['nama_dokter']); ?>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="form-inline my-1">
                                       <div class="row justify-content-center align-items-center flex-wrap">
                                          ...
                                          <div class="col-sm-6">
                                             <select name="jk_dokter" class="form-select" required>
                                                <option value="">Pilih Salah Satu</option>
                                                <option value="Laki-laki"
                                                   <?php if ($data['jk_dokter'] == "Laki-laki") { ?> selected
                                                   <?php } ?>>Laki-laki</option>
                                                <option value="Perempuan"
                                                   <?php if ($data['jk_dokter'] == "Perempuan") { ?> selected
                                    ...
                                    <div class="form-inline my-1">
                                       <div class="row justify-content-center align-items-start flex-wrap">
                                          ...
                                          <div class="col-sm-6">
                                             <textarea name="alamat_dokter" maxlength="30" class="form-control"
                                                placeholder="Enter Text ..." id=""
                                                rows="5"><?php echo $data['alamat_dokter'] ?></textarea>
                                          </div>
                                       </div>
                                    </div>
