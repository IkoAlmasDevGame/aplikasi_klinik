               ...
               <div class="panel panel-body bg-body-tertiary p-5">
                  <div class="panel panel-heading">
                     ...
                     <div class="d-flex justify-content-end align-items-end flex-wrap">
                        ...
                        <li class="breadcrumb breadcrumb-item">
                           <a href="?aksi=edit-users&id_pengguna=<?= $_GET['id_pengguna'] ?>" aria-current="page"
                        ...
                        <div class="card shadow mb-4">
                           ...
                           <div class="card-body my-2">
                              <div class="form-horizontal">
                                 <?php $users = $input->SELECT_WHERE("tb_user", "id_pengguna", $_GET['id_pengguna']); ?>
                                 <?php $data = mysqli_fetch_array($users); ?>
                                 <form action="?aksi=edit_users" class="form-group" role="form" method="post">
                                    ...
                                    <div class="form-inline my-2">
                                       <div class="row justify-content-center align-items-center flex-wrap">
                                          ...
                                          <div class="col-sm-6">
                                             <?php echo $input->form_input("text", "", "50", "form-control", "pengguna", "Enter Text ...", "", $data['pengguna']); ?>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="form-inline my-2">
                                       <div class="row justify-content-center align-items-center flex-wrap">
                                          ...
                                          <div class="col-sm-6">
                                             <select name="hak_akses" required class="form-select" id="">
                                                ...
                                                <option <?php if ($data['hak_akses'] == "admin") { ?> selected
                                                   <?php } ?> value="admin">Admin</option>
                                                <option <?php if ($data['hak_akses'] == "dokter") { ?> selected
                                                   <?php } ?> value="dokter">Dokter</option>
                                                <option <?php if ($data['hak_akses'] == "kepala_klinik") { ?> selected
                                                   <?php } ?> value="kepala_klinik">Kepala Klinik</option>
                                             </select>
                                          </div>
                                       </div>
                                    </div>
