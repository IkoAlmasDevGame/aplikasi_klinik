            ...
            <div class="panel panel-body bg-body-tertiary p-5">
               <div class="panel panel-heading">
                  ...
                  <div class="d-flex justify-content-end align-items-end flex-wrap">
                     ...
                     <li class="breadcrumb breadcrumb-item">
                        <a href="?page=laporan-rekam_medis" aria-current="page" class="text-decoration-none">
                           <?php echo $data[1]; ?>
                        </a>
                     </li>
                  </div>
                  ...
                  <div class="card-body my-2">
                     <div class="card-tools">
                        <div class="text-start my-1">
                           <a href="?page=print_rekam_medis" aria-current="page" class="btn btn-danger">
                              <i class="fas fa-print fa-fw fa-1x"></i>
                              Print File
                           </a>
                           <a href="?page=pdf_rekam_medis" aria-current="page" class="btn btn-info btn-outline-dark">
                           ...
                           <table class="table table-striped-columns table-layout" id="datatable1">
                              ...
                              <?php else: ?>
                                 <tbody>
                                    ...
                                    <?php $bc4 = $cmb->query("SELECT * FROM tb_pasien WHERE nik_pasien='$_POST[pencarian]'")->fetch_array(); ?>
                                    <?php $sql = $cmb->query("SELECT * FROM tb_rekam_medis WHERE id_pasien='$bc4[id_pasien]' ORDER BY id desc"); ?>
