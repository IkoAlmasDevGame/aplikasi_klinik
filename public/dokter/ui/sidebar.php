...
<?php $data = $cmb->query("SELECT * FROM tb_user WHERE id_pengguna = '$_SESSION[id_dokter]' and id_dokter = '$_SESSION[dokter]'") ?>
            ...
            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
               <li class="dropdown-header">
                  ...
                  <div class="text-center">
                     <a href="?page=edit-profile&pengguna=<?= $_SESSION['id_dokter'] ?>" aria-current="page"
                        class="btn btn-sm btn-info mx-1">
                        <i class="fas fa-fw fa-user-edit fa-1x"></i>
                        Edit Profile
                     </a>
                     <a href="?page=logout&id_pengguna=<?= $_SESSION['id_dokter'] ?>"
...
<aside id="sidebar" style="background: rgba(100, 107, 107, 1);" class="sidebar">
   <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
         <a href="?page=antrian" aria-current="page" class="nav-link collapsed">
            <i class="fas fa-fw fa-check fa-1x"></i>
            <div class="fs-6 display-4 text-dark fw-normal">Antrian Periksa</div>
         </a>
      </li>
      <div class="my-3 border border-top"></div>
      <li class="nav-item">
